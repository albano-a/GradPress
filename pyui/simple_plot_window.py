# Form implementation generated from reading ui file 'ui/simple_plot_window.ui'
#
...
"}")
    ...
    def retranslateUi(self, SimplePlotWindow):
        ...
        self.label.setText(_translate("SimplePlotWindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Gráfico Simples</span></p><p><span style=\" font-size:12pt;\">Preencha os campos abaixo para gerar um gráfico simples,<br/>apenas plotando o eixo x e o eixo y</span></p><p><br/></p></body></html>"))
        self.selectFileGroupBox.setTitle(_translate("SimplePlotWindow", "Arquivo"))
        self.label_2.setText(_translate("SimplePlotWindow", "<html><head/><body><p align=\"right\"><span style=\" font-size:10pt;\">Selecione o arquivo:</span></p></body></html>"))
        ...
        self.label_11.setText(_translate("SimplePlotWindow", "<html><head/><body><p align=\"center\">Arquivos aceitos até agora são o .csv e .txt. <br/>Futuramente há a pretensão de colocar <br> suporte a arquivos .xlsx</p></body></html>"))
        self.label_3.setText(_translate("SimplePlotWindow", "<html><head/><body><p align=\"right\">Tipo de arquivo:</p></body></html>"))
        self.groupBox_5.setTitle(_translate("SimplePlotWindow", "Configurações do Gráfico"))
        self.groupBox.setTitle(_translate("SimplePlotWindow", "Limitar a Profundidade"))
        self.label_6.setText(_translate("SimplePlotWindow", "Profundidade Mínima:"))
        self.label_7.setText(_translate("SimplePlotWindow", "Profundidade Máxima:"))
        self.groupBox_2.setTitle(_translate("SimplePlotWindow", "Título e eixos do gráfico"))
        self.label_12.setText(_translate("SimplePlotWindow", "Cor da Linha"))
        self.label_10.setText(_translate("SimplePlotWindow", "Eixo y:"))
        self.label_8.setText(_translate("SimplePlotWindow", "Título:"))
        self.label_9.setText(_translate("SimplePlotWindow", "Eixo x:"))
        self.cotaRadioBtnGroupBox.setTitle(_translate("SimplePlotWindow", "Configurações dos dados"))
        self.headerNao.setText(_translate("SimplePlotWindow", "Não"))
        self.labelHeaderLines.setStatusTip(_translate("SimplePlotWindow", "Se houver cabeçalho, quantas linhas pular?"))
        self.labelHeaderLines.setText(_translate("SimplePlotWindow", "<html><head/><body><p align=\"right\">Quantas linhas?:</p></body></html>"))
        self.cotaProfSim.setText(_translate("SimplePlotWindow", "Sim"))
        self.cotaProfNao.setText(_translate("SimplePlotWindow", "Não"))
        ...
        self.label_4.setText(_translate("SimplePlotWindow", "<html><head/><body><p align=\"right\">Profundidade em cota?:</p></body></html>"))
        ...
        self.labelMesaRotativa.setText(_translate("SimplePlotWindow", "<html><head/><body><p align=\"right\">Mesa Rotativa:</p></body></html>"))
        self.headerSim.setText(_translate("SimplePlotWindow", "Sim"))
        self.label_5.setStatusTip(_translate("SimplePlotWindow", "Se o arquivo possui cabeçalho. Comum em arquivos las e csv."))
        self.label_5.setText(_translate("SimplePlotWindow", "<html><head/><body><p align=\"right\">Cabeçalho?:</p></body></html>"))
        self.simplePlotBtn.setText(_translate("SimplePlotWindow", "Plotar"))
