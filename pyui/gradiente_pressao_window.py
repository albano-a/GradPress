# Form implementation generated from reading ui file 'ui/gradiente_pressao_window.ui'
#
...
"}")
        ...
        self.profMinInput = QtWidgets.QLineEdit(parent=self.widget)
        self.profMinInput.setObjectName("profMinInput")
        self.gridLayout_2.addWidget(self.profMinInput, 0, 1, 1, 1)
        self.profMaxInput = QtWidgets.QLineEdit(parent=self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(11, 24, 311, 81))
...
"}")
        ...
        self.csvRadioButton = QtWidgets.QRadioButton(parent=self.widget1)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.txtRadioButton = QtWidgets.QRadioButton(parent=self.widget1)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.xlsxRadioButton = QtWidgets.QRadioButton(parent=self.widget1)
        ...
        self.pressureComboBox = QtWidgets.QComboBox(parent=self.widget1)
        ...
        self.fileComboBox = QtWidgets.QComboBox(parent=self.widget1)
    ...
    def retranslateUi(self, gradientePressaoWindow):
        ...
        self.fluidClassificationBtn.setText(_translate("gradientePressaoWindow", "Classificar Fluidos"))
        self.saveOutputContent.setText(_translate("gradientePressaoWindow", "Salvar output"))
        self.label.setText(_translate("gradientePressaoWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; text-decoration: underline;\">Tabela de Gradiente de Pressão</span></p></body></html>"))
        self.groupBox.setTitle(_translate("gradientePressaoWindow", "Importação do arquivo"))
        self.groupBox_2.setTitle(_translate("gradientePressaoWindow", "Intervalo (opcional)"))
        self.label_4.setText(_translate("gradientePressaoWindow", "<html><head/><body><p align=\"right\">Prof. Mín:</p></body></html>"))
        self.label_5.setText(_translate("gradientePressaoWindow", "<html><head/><body><p align=\"right\">Prof. Máx:</p></body></html>"))
        self.label_2.setText(_translate("gradientePressaoWindow", "<html><head/><body><p align=\"right\">Arquivo:</p></body></html>"))
        self.label_3.setText(_translate("gradientePressaoWindow", "<html><head/><body><p align=\"right\">Unidade de pressão:</p></body></html>"))
        self.label_6.setText(_translate("gradientePressaoWindow", "<html><head/><body><p align=\"right\">Tipo de arquivo:</p></body></html>"))
