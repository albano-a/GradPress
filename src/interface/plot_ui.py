...
"}")
    ...
    def retranslateUi(self, SimplePlotWindow):
        ...
        self.label.setText(QCoreApplication.translate("SimplePlotWindow", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Gr\u00e1fico Simples</span></p><p><span style=\" font-size:12pt;\">Preencha os campos abaixo para gerar um gr\u00e1fico simples,<br/>apenas plotando o eixo x e o eixo y</span></p><p><br/></p></body></html>", None))
        self.selectFileGroupBox.setTitle(QCoreApplication.translate("SimplePlotWindow", u"Arquivo", None))
        self.label_2.setText(QCoreApplication.translate("SimplePlotWindow", u"<html><head/><body><p align=\"right\"><span style=\" font-size:10pt;\">Selecione o arquivo:</span></p></body></html>", None))
        ...
        self.label_11.setText(QCoreApplication.translate("SimplePlotWindow", u"<html><head/><body><p align=\"center\">Arquivos aceitos at\u00e9 agora s\u00e3o o .csv e .txt. <br/>Futuramente h\u00e1 a pretens\u00e3o de colocar <br> suporte a arquivos .xlsx</p></body></html>", None))
        self.label_3.setText(QCoreApplication.translate("SimplePlotWindow", u"<html><head/><body><p align=\"right\">Tipo de arquivo:</p></body></html>", None))
        self.groupBox_5.setTitle(QCoreApplication.translate("SimplePlotWindow", u"Configura\u00e7\u00f5es do Gr\u00e1fico", None))
        self.groupBox.setTitle(QCoreApplication.translate("SimplePlotWindow", u"Limitar a Profundidade", None))
        self.label_6.setText(QCoreApplication.translate("SimplePlotWindow", u"Profundidade M\u00ednima:", None))
        self.label_7.setText(QCoreApplication.translate("SimplePlotWindow", u"Profundidade M\u00e1xima:", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("SimplePlotWindow", u"T\u00edtulo e eixos do gr\u00e1fico", None))
        self.label_12.setText(QCoreApplication.translate("SimplePlotWindow", u"Cor da Linha", None))
        self.label_10.setText(QCoreApplication.translate("SimplePlotWindow", u"Eixo y:", None))
        self.label_8.setText(QCoreApplication.translate("SimplePlotWindow", u"T\u00edtulo:", None))
        self.label_9.setText(QCoreApplication.translate("SimplePlotWindow", u"Eixo x:", None))
        self.cotaRadioBtnGroupBox.setTitle(QCoreApplication.translate("SimplePlotWindow", u"Configura\u00e7\u00f5es dos dados", None))
        self.headerNao.setText(QCoreApplication.translate("SimplePlotWindow", u"N\u00e3o", None))
        ...
        self.labelHeaderLines.setText(QCoreApplication.translate("SimplePlotWindow", u"<html><head/><body><p align=\"right\">Quantas linhas?:</p></body></html>", None))
        self.cotaProfSim.setText(QCoreApplication.translate("SimplePlotWindow", u"Sim", None))
        self.cotaProfNao.setText(QCoreApplication.translate("SimplePlotWindow", u"N\u00e3o", None))
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(statustip)
        self.label_4.setText(QCoreApplication.translate("SimplePlotWindow", u"<html><head/><body><p align=\"right\">Profundidade em cota?:</p></body></html>", None))
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(statustip)
        self.labelMesaRotativa.setText(QCoreApplication.translate("SimplePlotWindow", u"<html><head/><body><p align=\"right\">Mesa Rotativa:</p></body></html>", None))
        self.headerSim.setText(QCoreApplication.translate("SimplePlotWindow", u"Sim", None))
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(statustip)
        self.label_5.setText(QCoreApplication.translate("SimplePlotWindow", u"<html><head/><body><p align=\"right\">Cabe\u00e7alho?:</p></body></html>", None))
        self.simplePlotBtn.setText(QCoreApplication.translate("SimplePlotWindow", u"Plotar", None))
