...
# Form implementation generated from reading ui file 'src/main/python/interface/design/gradient.ui'
#
...
class Ui_gradientePressaoWindow(object):
    def setupUi(self, gradientePressaoWindow):
        ...
        self.centralwidget = QtWidgets.QWidget(gradientePressaoWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.centralwidget)
        self.verticalLayout.setObjectName("verticalLayout")
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.fluidClassificationBtn = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.fluidPressureResults = QtWidgets.QTextBrowser(self.centralwidget)
        ...
        self.saveOutputContent = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.gridLayout.addWidget(self.saveOutputContent, 5, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.fluidPressureTableView = QtWidgets.QTableView(self.centralwidget)
...
"}")
        ...
        self.csvRadioButton = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.csvRadioButton.setFont(font)
        self.csvRadioButton.setObjectName("csvRadioButton")
        self.gridLayout_3.addWidget(self.csvRadioButton, 2, 1, 1, 1, QtCore.Qt.AlignHCenter)
        self.txtRadioButton = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.txtRadioButton.setFont(font)
        self.txtRadioButton.setObjectName("txtRadioButton")
        self.gridLayout_3.addWidget(self.txtRadioButton, 2, 2, 1, 1, QtCore.Qt.AlignHCenter)
        self.xlsxRadioButton = QtWidgets.QRadioButton(self.groupBox)
        self.xlsxRadioButton.setEnabled(True)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.xlsxRadioButton.setFont(font)
        self.xlsxRadioButton.setObjectName("xlsxRadioButton")
        self.gridLayout_3.addWidget(self.xlsxRadioButton, 2, 3, 1, 1, QtCore.Qt.AlignHCenter)
        self.pressureComboBox = QtWidgets.QComboBox(self.groupBox)
        ...
        self.fileComboBox = QtWidgets.QComboBox(self.groupBox)
        ...
        self.profMinInput = QtWidgets.QLineEdit(self.groupBox_2)
        self.profMinInput.setObjectName("profMinInput")
        self.gridLayout_2.addWidget(self.profMinInput, 0, 1, 1, 1)
        self.profMaxInput = QtWidgets.QLineEdit(self.groupBox_2)
        ...
        self.menubar = QtWidgets.QMenuBar(gradientePressaoWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 690, 21))
        self.menubar.setObjectName("menubar")
        gradientePressaoWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(gradientePressaoWindow)
