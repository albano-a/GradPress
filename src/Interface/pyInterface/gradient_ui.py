...
class Ui_gradientePressaoWindow(object):
    def setupUi(self, gradientePressaoWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 281, 61))
        ...
        self.profMinInput = QtWidgets.QLineEdit(parent=self.layoutWidget)
        self.profMinInput.setObjectName("profMinInput")
        self.gridLayout_2.addWidget(self.profMinInput, 0, 1, 1, 1)
        self.profMaxInput = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(11, 24, 311, 81))
        ...
        self.fileComboBox = QtWidgets.QComboBox(parent=self.layoutWidget1)
