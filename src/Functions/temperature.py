...
def main():
	...
	temp_top, tvdss_top, y_top, temp_bot, tvdss_bot, y_bot = ridge_regression(temp, tvdss)
	temp_top, temp_bot, best_break = finding_best_breakpoit(temp_top, temp_bot, tvdss, break_range=(-50, 50))
	print(best_break)
	# y = ax + b
	...
	plot2.plot(temp_total, predic, '--', color='red', label=f'y = {a[0]:.2f}x + {b:.2f}')
